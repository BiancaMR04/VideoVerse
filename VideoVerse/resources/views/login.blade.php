...
<form class="form @if(isset($msg) && !empty($msg)) has-error @endif" method="post" action="/login">
    @csrf
    ...
    <div class="btn">
        <a href="/home-visitor">
            <button class="button1" style="margin-right: 7px;" type="button">Entrar como visitante</button>
        </a>
        <button class="button1" style="margin-left: 7px;" type="submit" formaction="/login">Entrar</button>
    </div>
